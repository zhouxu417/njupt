...
//print_r($vie);
     ...
     $post1['Button1'] = '%B0%B4%D1%A7%C6%DA%B2%E9%D1%AF';
	 $post1['ddlXN'] = '';
	 $post1['ddlXQ'] = '';
...
curl_setopt($ch2, CURLOPT_REFERER, "http://202.119.225.34/xscj_gc.aspx?xh=B12050324&xm=%D6%DC%D0%F1&gnmkdm=N121605");

$res1 = curl_exec($ch2);
curl_close($ch2);
//print_r($res1);

$pattern1 =  '/<table class="datelist" cellspacing="0" cellpadding="3" border="0" id="Datagrid1" width="100%">(.*?)<\/table>/is';
